...
const TripCard = (props: Props) => {
  ...
  return (
    <div onMouseEnter={()=>setIsHovered(true)} onMouseLeave={()=>setIsHovered(false)} className='shadow-xl w-full lg:w-1/3 cursor-pointer  p-2 rounded-md border overflow-hidden border-slate-100 hover:bg-slate-50 ' >
