  ...
  return (
    <Box>
        <Grid container spacing={2}>
            <Grid item xs={8}>
                <Paper elevation={0} sx={{display:'flex',flexDirection:'column',justifyContent:'flex-end',overflow:'hidden',height:'300px',background:"url('https://images.pexels.com/photos/163036/mario-luigi-yoschi-figures-163036.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')",backgroundSize:'cover'}}>
                    <Box 
